...
st.markdown("Загрузите аудиофайл (`.wav`,`.mp3`,`.m4a`), затем нажмите **Проанализировать**, чтобы определить наличие аномалий в работе двигателя.")

# === ЗАГРУЗКА ФАЙЛА ===
uploaded_file = st.file_uploader("Загрузите аудиофайл", type=["wav", "mp3", "m4a"])
